<template>
  <div class="container">
    <p style="font-size: 24px;">
      <strong>lorem ipsum dolor, sit amet consectetur adipisicing elit. Deleniti ullam odit suscipit tenetur? Inventore mollitia itaque quis nemo</strong>
    </p>
    ...
    <div class="answer-container">
      <p>20 Answer</p>
      <div class="content" v-for="(answer, i) in answers" :key="i">
        <div class="vote">
          <i class="fas fa-chevron-up fa-2x"></i>
          <p>23445</p>
          <i class="fas fa-chevron-down fa-2x"></i>
